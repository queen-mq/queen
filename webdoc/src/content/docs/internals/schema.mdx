...
# sourceOfTruth re-read 2026-09-09 (through ff644495 + this patch): the two functions 1.5.3 adds to 010 and 011 are now in their tables; the file count is unchanged.
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): the lease_time row is corrected for the merge rule and get_queue_v2's row for its new options object; 024_kv.sql's two new functions are console reads, documented on the KV reference page.
---
