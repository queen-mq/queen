...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): db.rs gained the DLQ move and KV console statements; no admission, pacing or pool behaviour moved.
---
