...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): the dead-letter removal sentence is rewritten for the move primitive, which deletes the row in the same transaction as the push; schema.sql changed one comment.
---
