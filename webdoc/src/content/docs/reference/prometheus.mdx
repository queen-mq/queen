...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): auth.rs gained one read-only arm; the exposition, its families and its access rules are unchanged.
---
