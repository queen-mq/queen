...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): main.rs registers three new routes and introduces no environment variable; the generated table is current.
---
