...
sourceOfTruth:
  ...
  - proxy/src/oauth.rs
# sourceOfTruth re-read 2026-09-09 (through ff644495): the three analytics operations 1.5.3 adds are already in the generated coverage table; page matches the code.
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): the generated spec gains the three new operations and a Key/value state and timers tag that now matches the route table's grouping; the process this page describes is unchanged.
---
