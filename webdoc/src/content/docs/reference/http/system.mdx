...
description: "Maintenance mode, the kv and timer kill switches, shared state, the stats refresh trigger and the broker-to-broker /internal routes: all admin-gated operator surfaces."
type: reference
tier: operate
status: internal
sidebar:
