...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): push maintenance now also refuses a dead-letter replay with 503, stated under the maintenance route; maintenance.rs and switches.rs changed only comments otherwise.
---
