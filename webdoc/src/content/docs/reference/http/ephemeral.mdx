...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): main.rs's three new routes, switches.rs's comment, and classify's two replay arms; the ephemeral family's own classes and gates are unchanged.
---
