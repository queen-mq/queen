...
sourceOfTruth:
  - server/src/main.rs
  - server/src/auth.rs
# sourceOfTruth re-read 2026-09-09 (through ff644495): the three analytics routes 1.5.3 adds are already in the generated table; page matches the code.
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): the three new broker routes and the KV console access arm are in the generated table already; the prose that explains it is unchanged.
---
