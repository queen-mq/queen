...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): main.rs, auth.rs and db.rs gained the replay and KV console routes; nothing this page describes moved.
---
