...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): 024_kv.sql gained the two console read functions, which no transaction rider can call; the rider's own limits are unchanged.
---
