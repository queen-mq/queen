...
sidebar:
  ...
  label: SQS protocol
sourceOfTruth:
  - queen-sqs/src/actions/mod.rs
  - queen-sqs/src/actions/queues.rs
  - queen-sqs/src/actions/messages.rs
  - queen-sqs/src/actions/fifo.rs
  - queen-sqs/src/actions/dlq.rs
  - queen-sqs/src/registry.rs
  - queen-sqs/src/envelope.rs
  - queen-sqs/src/handle.rs
  - queen-sqs/src/proto/mod.rs
  - queen-sqs/src/error.rs
  - queen-sqs/src/sigv4.rs
  - queen-sqs/src/sns/mod.rs
  - queen-sqs/src/sns/admin.rs
  - queen-sqs/src/sns/publish.rs
---
...
**Run against a real broker**, in `queen-sqs/compat`: boto3 and botocore 1.43 (AWS JSON 1.0, 99 of
