...
digest: >-
  ...
  availability. Nothing is installed into either required part: the DDL and the 23
...
Nothing is installed into either required part. The DDL and the 23 stored-procedure files are
