...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + working tree): classify gained the two DLQ replay arms; the sink's own routes, classes and retention interaction are untouched.
---
