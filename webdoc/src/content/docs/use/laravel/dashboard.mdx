...
Responses use a nonce-based Content Security Policy, `no-store`, frame denial, MIME-sniffing
denial and a no-referrer policy. The view loads no scripts, fonts or other assets from a CDN.
