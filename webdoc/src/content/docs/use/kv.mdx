...
# sourceOfTruth re-read 2026-09-11 (through bcea60c0 + this patch): the console list (PLAN_DASHBOARD_ACTIONS.md §2.5) is now in the reads section; the rest matches the code.
---
