...
sourceOfTruth:
  ...
  - clients/client-php/src/Consumer/ConsumerManager.php
  - clients/client-php/src/Timers.php
...
verifiedBy:
  - clients/client-php/tests/QueueBuilderTest.php
  - clients/client-php/tests/HighLevelConsumerTest.php
  - clients/client-php/tests/HttpClientTest.php
  - clients/client-php/tests/TimersTest.php
  - clients/client-php/tests/LaravelQueueDriverTest.php
  - clients/client-php/tests/LaravelServiceProviderTest.php
...
one entry per item, each carrying a `status` of `queued`, `duplicate` or `error`.
