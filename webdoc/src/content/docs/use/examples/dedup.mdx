...
description: "Deduplication is exact, per-partition and window-bounded: how to choose a deterministic transaction id, what a duplicate response looks like, and what happens once the window closes."
type: example
tier: use
sidebar:
  order: 23
