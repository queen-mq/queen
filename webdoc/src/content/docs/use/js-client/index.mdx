...
The JavaScript client is the reference implementation, the one every other SDK is a
transliteration of: ESM only, Node 22 or newer, broker client and streaming SDK in one package.
