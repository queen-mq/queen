...
the database, and cross-instance wake-ups ride the periodic floors instead of peer frames
(a parked pop re-polls within a second, wildcard discovery within the reseed interval,
configuration changes within the reconcile interval).
