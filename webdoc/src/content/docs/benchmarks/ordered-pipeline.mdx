...
description: "Queen 1.x on PostgreSQL: 88,503,408 messages through four stages with 0 duplicates, 0 gaps and 0 order violations."
type: reference
sidebar:
  order: 5
sourceOfTruth:
...
The result took two 1.x broker fixes: the mass-creation livelock, broken by ordered provisioning
inserts and a non-blocking advisory lock, and index churn under heavy updates, bounded by
