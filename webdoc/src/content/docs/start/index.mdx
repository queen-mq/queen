...
<CardGrid>
  ...
  <LinkCard
    ...
    description="What Queen does not do, what it deliberately refuses to do, and where the sharp edges are."
  />
  <LinkCard
    href="/start/compare"
    title="Compared to Kafka, RabbitMQ, SQS and pgmq"
    description="Architectural differences, stated without performance claims we have not measured."
  />
</CardGrid>
