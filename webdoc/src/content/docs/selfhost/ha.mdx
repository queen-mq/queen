...
A lost frame costs latency rather than correctness, because every channel the
mesh accelerates has a periodic floor underneath it that re-reads the database:
