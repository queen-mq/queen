...
place. `server/src/schema.rs` holds the authoritative list of 24 procedure files
...
(`schema.sql` plus 24 procedure files, as 25 separate batches) and unlocks. The
