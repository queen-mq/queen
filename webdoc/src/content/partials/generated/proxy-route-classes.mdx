...
{/* GENERATED FILE — do not edit by hand.
    ...
    Source of truth:
      - queen_proxy/src/routes.rs (classify, is_operator_route)
...
42 of the broker's 60 method + path pairs are reachable with a tenant credential; the rest are operator or blocked surfaces.
