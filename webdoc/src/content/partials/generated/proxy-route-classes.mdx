...
{/* GENERATED FILE. Do not edit by hand.
    ...
    Source of truth:
      ...
      - server/src/rsm/facade/real/phase2.rs (api_impl, api_dynamic)
*/}
...
73 of the broker's 98 method + path pairs are reachable with a tenant credential; the rest are operator or blocked surfaces.
