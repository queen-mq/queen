---
params: []
description: "Verified snippet extracted from examples/full/rust/src/bin/01_produce_consume.rs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/full/rust/src/bin/01_produce_consume.rs by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```rust title="examples/full/rust/src/bin/01_produce_consume.rs"
//
