---
params: []
description: "Verified snippet extracted from examples/tutorials/js/02-multi-queue-flow.mjs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/js/02-multi-queue-flow.mjs by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```js title="examples/tutorials/js/02-multi-queue-flow.mjs"
//
