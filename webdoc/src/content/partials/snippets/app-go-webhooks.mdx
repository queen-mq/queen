---
params: []
description: "Verified snippet extracted from examples/apps/go/webhooks/main.go."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/go/webhooks/main.go by webdoc/scripts/gen-snippets.mjs
