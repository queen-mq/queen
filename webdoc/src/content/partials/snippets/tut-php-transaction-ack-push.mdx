---
params: []
description: "Verified snippet extracted from examples/tutorials/php/03-transaction-ack-push.php."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/php/03-transaction-ack-push.php by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```php title="examples/tutorials/php/03-transaction-ack-push.php"
//
