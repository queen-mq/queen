---
params: []
description: "Verified snippet extracted from examples/cross-protocol/consumer.mjs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/cross-protocol/consumer.mjs by webdoc/scripts/gen-snippets.mjs
