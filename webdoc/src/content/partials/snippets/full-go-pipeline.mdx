---
params: []
description: "Verified snippet extracted from examples/full/go/pipeline-transaction/main.go."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/full/go/pipeline-transaction/main.go by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```go title="examples/full/go/pipeline-transaction/main.go"
