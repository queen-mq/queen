---
params: []
description: "Verified snippet extracted from examples/full/js/03-pipeline-transaction.mjs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/full/js/03-pipeline-transaction.mjs by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```js title="examples/full/js/03-pipeline-transaction.mjs"
//
