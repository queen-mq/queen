---
params: []
description: "Verified snippet extracted from examples/apps/http/webhooks.sh."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/http/webhooks.sh by webdoc/scripts/gen-snippets.mjs
