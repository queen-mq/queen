---
params: []
description: "Verified snippet extracted from examples/apps/cpp/chat.cpp."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/cpp/chat.cpp by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```cpp title="examples/apps/cpp/chat.cpp"
//
