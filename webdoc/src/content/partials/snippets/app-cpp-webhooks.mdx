---
params: []
description: "Verified snippet extracted from examples/apps/cpp/webhooks.cpp."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/cpp/webhooks.cpp by webdoc/scripts/gen-snippets.mjs
