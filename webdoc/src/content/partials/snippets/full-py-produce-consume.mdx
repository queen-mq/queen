---
params: []
description: "Verified snippet extracted from examples/full/py/01_produce_consume.py."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/full/py/01_produce_consume.py by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```python title="examples/full/py/01_produce_consume.py"
