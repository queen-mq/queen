---
params: []
description: "Verified snippet extracted from examples/apps/rust/src/bin/chat.rs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/rust/src/bin/chat.rs by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```rust title="examples/apps/rust/src/bin/chat.rs"
//
