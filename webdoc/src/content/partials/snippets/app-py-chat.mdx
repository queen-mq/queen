---
params: []
description: "Verified snippet extracted from examples/apps/py/chat.py."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/py/chat.py by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```python title="examples/apps/py/chat.py"
#
