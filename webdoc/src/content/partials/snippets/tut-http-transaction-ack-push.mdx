---
params: []
description: "Verified snippet extracted from examples/tutorials/http/03-transaction-ack-push.sh."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/http/03-transaction-ack-push.sh by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```bash title="examples/tutorials/http/03-transaction-ack-push.sh"
#!/usr/bin/env bash
#
