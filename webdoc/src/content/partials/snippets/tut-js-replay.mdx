---
params: []
description: "Verified snippet extracted from examples/tutorials/js/04-replay.mjs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/js/04-replay.mjs by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```js title="examples/tutorials/js/04-replay.mjs"
//
