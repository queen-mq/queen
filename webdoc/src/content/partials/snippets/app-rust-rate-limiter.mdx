---
params: []
description: "Verified snippet extracted from examples/apps/rust/src/bin/rate_limiter.rs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/rust/src/bin/rate_limiter.rs by webdoc/scripts/gen-snippets.mjs
