---
params: []
description: "Verified snippet extracted from examples/tutorials/cpp/01-hello-world.cpp."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/cpp/01-hello-world.cpp by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```cpp title="examples/tutorials/cpp/01-hello-world.cpp"
//
