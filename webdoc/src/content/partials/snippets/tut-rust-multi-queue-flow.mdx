---
params: []
description: "Verified snippet extracted from examples/tutorials/rust/src/bin/02_multi_queue_flow.rs."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/rust/src/bin/02_multi_queue_flow.rs by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```rust title="examples/tutorials/rust/src/bin/02_multi_queue_flow.rs"
//
