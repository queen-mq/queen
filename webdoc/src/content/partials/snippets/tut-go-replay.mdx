---
params: []
description: "Verified snippet extracted from examples/tutorials/go/replay/main.go."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/go/replay/main.go by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```go title="examples/tutorials/go/replay/main.go"
//
