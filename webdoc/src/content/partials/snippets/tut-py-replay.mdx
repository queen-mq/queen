---
params: []
description: "Verified snippet extracted from examples/tutorials/py/04_replay.py."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/tutorials/py/04_replay.py by webdoc/scripts/gen-snippets.mjs
    Regenerate with: pnpm --dir webdoc gen
*/}

```python title="examples/tutorials/py/04_replay.py"
#
