---
params: []
description: "Verified snippet extracted from examples/apps/php/webhooks.php."
---

{/* GENERATED FILE. Do not edit by hand.
    Extracted from examples/apps/php/webhooks.php by webdoc/scripts/gen-snippets.mjs
