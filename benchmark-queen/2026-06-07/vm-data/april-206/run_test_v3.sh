...
docker run -d --ulimit nofile=65535:65535 \
  ...
  -e NUM_WORKERS=10 -e DB_POOL_SIZE=50 -e SIDECAR_POOL_SIZE=250 -e QUEEN_CONCURRENCY_MODE=static -e QUEEN_POP_MAX_CONCURRENT=16 ${PUSH_HOLD_MS:+-e QUEEN_PUSH_MAX_HOLD_MS=$PUSH_HOLD_MS} \
