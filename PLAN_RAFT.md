...
| D6 | Every mutating command carries a 16-byte request id minted once by the receiver. Outcomes are kept in state for `QUEEN_RAFT_REQUEST_ID_WINDOW_S` (60; 600 until 2026-09-23, when it measured ~4 GB of outcomes at 200k msg/s). | A write in flight during a leadership change has an unknown outcome (openraft GH#2095). |
...
| QUEEN_RAFT_REQUEST_ID_WINDOW_S | 60 | D6 |
