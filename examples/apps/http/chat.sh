...
# not named lands on its default: the option this program depends on and does
# not send is dedupWindowSeconds, whose default of 3600 seconds is what makes
# the resend below a duplicate.
# ---------------------------------------------------------------------------
