// docs:start(full-go-produce-consume)
...
func run(ctx context.Context) error {
	...
	// queue already has, and this client sends only the non-zero fields of
	// QueueConfig. The queue name is unique per run, so nothing is being kept
	// here and every option left out lands on its default.
